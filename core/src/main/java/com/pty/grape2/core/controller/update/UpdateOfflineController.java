...
@Slf4j
@FXMLController
public class UpdateOfflineController implements Initializable {
    ...
    @FXML
    private TreeTableColumn ttcName;
    ...
    private void initAsset() {
        RuntimeConstant.RUNTIME_ASSET.setUpdateOfflineBurger(burger);
        tglBtnFrontend.setSelected(true);
        tglBtnServer.setSelected(true);
        tglBtnSql.setSelected(true);
    }
